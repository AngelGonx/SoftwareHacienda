...
CREATE TABLE `tabla_licencia_generada` (
  ...
  `apellido_pat` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `apellido_mat` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `edad` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `domicilio` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `fecha_nac` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `cp` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `lugar` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `celular` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `crated_by` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `tabla_multas` (
  ...
  `concepto_pago` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `precio` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `created_by` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `tabla_multas_generadas` (
  ...
  `apellido_mat` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `domicilio` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `placa_vehiculo` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `marca_vehiculo` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `nserie_vehiculo` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `modelo_vehiculo` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `limite_pago` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `created_by` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
CREATE TABLE `tabla_propietario` (
  ...
  `lugar` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `created_by` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `updated_by` varchar(45) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
CREATE TABLE `tabla_tipo_licencia` (
  `id` int NOT NULL AUTO_INCREMENT,
  `concepto_cobro` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Dumping events for database 'hacienda'
--

--
-- Dumping routines for database 'hacienda'
--
...
-- Dump completed on 2021-09-29 16:47:20
